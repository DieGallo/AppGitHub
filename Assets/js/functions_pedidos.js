let tablePedidos;
let rowTable;
tableProductos = $('#tablePedidos').dataTable( {
    "aProcessing":true,
    "aServerSide":true,
    "language": {
...
function fntReembolsar(){
    ...
    if(idtransaccion == '' || observacion == ''){
        swal("", "Complete todos los datos para continuar.", "error");
        return false;
    }
    swal({
        title: "Hacer Reembolso",
        text: "¿Está seguro de realizar el reembolso?",
        type: "warning",
        showCancelButton: true,
        confirmButtonText: "Si, realizar reembolso!",
