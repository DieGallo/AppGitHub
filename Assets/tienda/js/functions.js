...
if(document.querySelector("#txtColoniaEnvio")){
  let colonia = document.querySelector("#txtColoniaEnvio");
  colonia.addEventListener('keyup', function(){
    let col = this.value;
    fntViewPago();
  });
}
...
if(document.querySelector("#txtEstadoEnvio")){
  let estado = document.querySelector("#txtEstadoEnvio");
...
function fntViewPago(){
  ...
  let colonia = document.querySelector("#txtColoniaEnvio").value;
  let ciudad = document.querySelector("#txtCiudad").value;
  let estado = document.querySelector("#txtEstadoEnvio").value;

  if(direccion == "" || colonia == "" || ciudad == "" || estado == ""){
...
if(document.querySelector("#btnComprar")){
  ...
  btnPago.addEventListener('click', function(){ 
    ...
    let col = document.querySelector("#txtColoniaEnvio").value;
    let ciudad = document.querySelector("#txtCiudad").value;
    let est = document.querySelector("#txtEstadoEnvio").value;

    let inttipopago = document.querySelector("#listtipopago").value;
    if(txtDireccion == "" || txtColoniaEnvio == "" || txtCiudad == "" || txtEstadoEnvio == ""){
...
if(document.querySelector("#frmSuscripcion")){
  ...
  frmSuscripcion.addEventListener('submit', function(e){
    ...
    if(!fntEmailValidate(email)){
      swal("", "El email es obligatorio", "error");
      return false;
    }
