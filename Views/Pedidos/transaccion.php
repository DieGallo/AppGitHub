  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <?php }else{ 
          ...
          $direccion2 = $trs->shipping->address->address_line_2;
          $direccion3 = $trs->shipping->address->admin_area_1;
          $direccion4 = $trs->shipping->address->admin_area_2;
        ...
        <section id="sPedido" class="invoice">
          <div class="row mb-4">
            <div class="col-6">
              <h2 class="page-header"><img src="<?= media(); ?>/images/img-paypal.jpg" alt="Logotipo Paypal"></h2>
            </div>
            <?php if(!$reembolso){ 
          ...
          <div class="row invoice-info">
            <div class="col-4">
              <address><strong>Transacción:</strong> <?= $idTransaccion; ?><br><br>
                <strong>Fecha:</strong> <?= $fecha; ?><br>
                <strong>Estado:</strong> <?= $estado; ?><br>
                <strong>Importe bruto:</strong> <?= $monto; ?><br>
