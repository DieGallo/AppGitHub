        ...
        <div class="col-md-6">
          <div class="tile">
            <div class="container-title">
              <?php //dep($data['productosTen']); Obtenemos todo el array de los productos ?>
              <h3 class="tile-title">Últmos productos</h3>
              <table class="table table-striped table-sm">
              <thead>
                <tr>
                  <th>#</th>
...
<script>
  Highcharts.chart('graficaMes', {
      ...
      title: {
          text: 'Tus compras de <?= $data['ventasMDia']['mes'].' '.$data['ventasMDia']['anio'] ?>'
      },
      subtitle: {
        text: 'El total de tus compras fueron de: <?= SMONEY.'. '.formatMoney($data['ventasMDia']['total']) ?>'
      },
      xAxis: {
          categories: [
              <?php 
