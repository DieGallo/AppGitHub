					...
					?>
						<div>
							...
							<div class="bor8 bg0 m-b-22">
								<input id="txtColoniaEnvio" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Colonia/Fraccionamiento/Residencia">
							</div>
							<label>Ciudad</label>
							<div class="bor8 bg0 m-b-22">
							...
							<label>Estado</label>
							<div class="bor8 bg0 m-b-22">
								<input id="txtEstadoEnvio" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Estado/Provincia/Región">
							</div>
						</div>
					<?php }else{ ?>
			...
			<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
					...
					<?php 
						if(isset($_SESSION['login'])){
					?>
					<div class="notblock" id="divMetodoPago">
						...
						<hr>
							...
							<div class="divmetodpago">
								...
								<div id="divpaypal">
									<div>
										<p>Para completar la transacción, te enviaremos a los servidores de PayPal.</p>
									</div>
									<br>
